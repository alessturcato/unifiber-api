...
return [
     ...
     */
    'description' => 'Api per la gestione delle coperture Unifiber. Registrazione, Recupero e Versione.',

    /*
     * The base URL displayed in the docs. If this is empty, Scribe will use the value of config('app.url').
     */
    'base_url' => null,// 'http://localhost:8301',
    ...
    'routes' => [
        [
            ...
            'match' => [
                 ...
                 */
                'prefixes' => ['api/v1/coperture_unifiber_test/ricerca'],
        ...
        [
            ...
            'match' => [
                 ...
                 * Match only routes whose paths match this pattern (use * as a wildcard to match any characters). Example: 'users/*'.
                 */
                'prefixes' => ['api/v1/coperture_unifiber_test/storico/*'],
        ...
        [
            ...
            'match' => [
                 ...
                 * Match only routes whose paths match this pattern (use * as a wildcard to match any characters). Example: 'users/*'.
                 */
                'prefixes' => ['api/v1/coperture_unifiber_test/registra'],
     ...
     */
    'intro_text' => <<<INTRO
    Questa documentazione mira a fornire tutte le informazioni necessarie per lavorare con le API Unifiber.
    ...
    Puoi cambiare la lingua utilizzata con le schede in alto a destra (o dal menu di navigazione in alto a sinistra sul cellulare).</aside>
    INTRO
    ,
     ...
     */
    'logo' =>  [
        'image'=>'./images/logo_unifiber_2.png',
        'width' => '170px',
        'height' => '60px',
        'style' => 'padding:10px;'
    ],
